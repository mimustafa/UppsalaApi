...
namespace UppsalaApi.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> GetVisibleUsersAsync(
            ...
            [FromQuery] SortOptions<UserResource, UserEntity> sortOptions,
            [FromQuery] SearchOptions<UserResource, UserEntity> searchOptions,
            CancellationToken ct)
        {
            ...
            var users = new PagedResults<UserResource>();
            ...
            var collection = PagedCollection<UserResource>.Create<UsersResponse>(
                Link.To(nameof(GetVisibleUsersAsync)),
                users.Items?.ToArray() ?? new UserResource[0],
                users.TotalSize,
                pagingOptions);
